...
- Generally, before developing enhancements to this charm, you should consider [opening an issue](https://github.com/canonical/kafka-connect-operator/issues) explaining your problem with examples, and your desired use case.
...
git clone https://github.com/canonical/kafka-connect-operator.git
cd kafka-connect-operator/

# Create a working model
juju add-model connect
...
# Deploy the latest Apache Kafka in KRaft mode
juju deploy kafka --channel 3/edge --config roles="broker,controller"

# Deploy the charm
juju deploy ./*.charm

# After Apache Kafka has initialised, relate the applications
